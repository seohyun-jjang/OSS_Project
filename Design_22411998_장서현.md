...
- HTML, CSS, JavaScript 기반의 직관적인 웹 사용자 인터페이스를 제공하여 사용 편의성을 향상시킨다.
...
본 프로젝트는 HTML, CSS, JavaScript 기반의 웹 환경으로 구현되었으며, Visual Studio Code를 개발 도구로 사용한다. 또한 Git과 GitHub를 이용하여 소스 코드와 설계 산출물을 관리한다.
...
| 항목 | 권장 사양 | 비고 |
| :--- | :--- | :--- |
| **CPU** | Intel Core i3 이상 | 웹 애플리케이션 실행 및 데이터 처리 |
| **RAM** | 4GB 이상 | 원활한 웹 화면 실행 |
| **HDD / SSD** | 500MB 이상의 여유 공간 | 프로젝트 파일 및 소스 코드 저장 |
| **Display** | 1366 × 768 이상 | 웹 화면 출력 |
| **Network** | 인터넷 연결 권장 | GitHub 저장소 연동 및 웹 페이지 실행 |
...
| **개발 언어** | Language | HTML, CSS, JavaScript |
| **UI 구현 방식** | UI Framework | Web-based User Interface |
| **개발 도구** | IDE | Visual Studio Code |
| **버전 관리** | Version Control | Git, GitHub |
| **실행 환경** | Browser | Google Chrome, Microsoft Edge 등 최신 웹 브라우저 |

# 6. Glossary

| 용어 | 설명 |
| :--- | :--- |
| **GUI** | Graphical User Interface의 약자로 사용자가 화면을 통해 시스템과 상호작용할 수 있는 인터페이스 |
| **Web Prototype** | 실제 서비스 개발 이전에 주요 기능과 화면 구성을 확인하기 위해 구현한 웹 기반 시제품 |
| **HTML** | 웹 페이지의 구조를 정의하는 마크업 언어 |
| **CSS** | 웹 페이지의 디자인과 레이아웃을 정의하는 스타일 시트 언어 |
| **JavaScript** | 웹 페이지의 동적인 기능과 사용자 상호작용을 구현하는 프로그래밍 언어 |
| **Visual Studio Code** | 본 프로젝트 구현에 사용된 소스 코드 편집기 |
| **Git** | 소스 코드의 변경 이력을 관리하기 위한 분산 버전 관리 시스템 |
| **GitHub** | Git 저장소를 온라인으로 관리하고 협업할 수 있는 플랫폼 |

# 7. References

1. 강의자료, *오픈소스설계 Behavior Modeling I*

2. 강의자료, *오픈소스설계 Behavior Modeling II*

3. 강의자료, *오픈소스설계 Structural Modeling I*

4. 강의자료, *오픈소스설계 Structural Modeling II*
