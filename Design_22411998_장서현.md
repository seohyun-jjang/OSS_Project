...
| **Java** | 본 시스템 구현에 사용된 객체지향 프로그래밍 언어 |
| **Java Swing** | Java 기반의 데스크톱 GUI 애플리케이션 개발 라이브러리 |
| **JDK** | Java Development Kit의 약자로 Java 프로그램 개발 및 실행 환경 |
| **IntelliJ IDEA** | 본 프로젝트 구현에 사용된 통합 개발 환경(IDE) |
